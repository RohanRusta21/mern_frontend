...
const SearchAppBar=()=>{
    ...
    return (
        <Box sx={{ flexGrow: 1 }}>
          <AppBar position="static" style={{background:'#FFF',height:"80px",alignItems:"left",justifyContent:"center"}} >
           ...
           <Link style={{textDecoration:'none',color:'inherit'}} to='/Dashboard/Onboard'>
  <ListItemButton>
    <ListItemIcon>
    <CategoryIcon />
    </ListItemIcon>
  ...
  <Link style={{textDecoration:'none',color:'inherit'}} to='/Dashboard/DisplayOnboard'>
  <ListItemButton>
    <ListItemIcon>
    <CategoryIcon />
    </ListItemIcon>
  ...
  <Link style={{textDecoration:'none',color:'inherit'}} to='/Dashboard/Jml'>
  <ListItemButton>
    <ListItemIcon>
    <CategoryIcon />
    </ListItemIcon>
